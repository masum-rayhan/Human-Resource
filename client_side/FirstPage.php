...
You are a wonderful person with a wonderful view of life. Your companionship is always an opportunity to learn. A warm welcome to you to join us!</p>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
						<h4>Follow Us @</h4>
						<br>
						<a href="https://www.facebook.com/Fahim.Faysal.Siyam/" title="Facebook" target="_blank" ><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
						<a href="https://twitter.com/FaysalSiyam"title="Twitter"  target="_blank"><i class="fa fa-twitter-square" aria-hidden="true"></i></a>
						<a href="https://www.youtube.com/channel/UCi86hUBOPJZ5mfm08MADY6g" title="Youtube" target="_blank" ><i class="fa fa-youtube-square" aria-hidden="true"></i></a>
						<a href="https://www.instagram.com/fahim_faysal_siyam/" title="Instagram" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="copyrightt">
		  <div class="container">
		  	<div class="row">
			    <div class="col-md-6">
			      <p>Copyright © 2020 - All Rights Reserved to <span style="color:red;">Masum Rayhan</span></p>
			    </div>
			</div>
		  </div>
		</div>
