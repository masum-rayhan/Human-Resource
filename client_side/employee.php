<?php
  ...
  include('../includes/getempdata.php');
...
<div class="hrms_container">
           ...
           <nav class="navbar navbar-inverse navbar-static-top">
                  <div class="container-fluid">
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand" href="../client_side/employee.php"><i class="fa fa-amazon" aria-hidden="true"></i> a<span style="color: #F7DC6F">maz</span>on</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                          ...
                          <li><a href="leave.php" target="_blank">Application for leave</a></li>
                          <li><a href="review.php" target="_blank">Give review</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                           <li class="dropdown">
                                ...
                                <ul class="dropdown-menu nav nav-pills nav-stacked">
                                      <li class="active"><a href="modify.php"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Modify information</a></li>
    ...
    <div class="hrms_footer" style="text-align: center;">
            <address>
              <strong>Copyright&copy;XXX Corporation. Inc</strong><br>
              Banani,Dhaka-Bangladesh<br>
              <abbr title="Phone">Phone:</abbr>01788169809
            </address>
    </div><!-- /.hrms_footer -->
